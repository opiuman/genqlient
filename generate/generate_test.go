		...
		t.Run(sourceFilename, func(t *testing.T) {
			generated, err := Generate(&Config{
				...
				Bindings: map[string]*TypeBinding{
					"ID":       {Type: "github.com/opiuman/genqlient/internal/testutil.ID"},
					"DateTime": {Type: "time.Time"},
					"Date": {
						Type:        "time.Time",
						Marshaler:   "github.com/opiuman/genqlient/internal/testutil.MarshalDate",
						Unmarshaler: "github.com/opiuman/genqlient/internal/testutil.UnmarshalDate",
					},
					"Junk":        {Type: "interface{}"},
					"ComplexJunk": {Type: "[]map[string]*[]*map[string]interface{}"},
					"Pokemon": {
						Type:              "github.com/opiuman/genqlient/internal/testutil.Pokemon",
						ExpectExactFields: "{ species level }",
					},
					"PokemonInput": {Type: "github.com/opiuman/genqlient/internal/testutil.Pokemon"},
				},
...
func TestGenerateWithConfig(t *testing.T) {
	tests := []struct {
		...
		{"CustomContext", "", nil, &Config{
			Generated:   "generated.go",
			ContextType: "github.com/opiuman/genqlient/internal/testutil.MyContext",
		}},
		...
		{"ClientGetter", "", nil, &Config{
			Generated:    "generated.go",
			ClientGetter: "github.com/opiuman/genqlient/internal/testutil.GetClientFromContext",
		}},
		{"ClientGetterCustomContext", "", nil, &Config{
			Generated:    "generated.go",
			ClientGetter: "github.com/opiuman/genqlient/internal/testutil.GetClientFromMyContext",
			ContextType:  "github.com/opiuman/genqlient/internal/testutil.MyContext",
		}},
		{"ClientGetterNoContext", "", nil, &Config{
			Generated:    "generated.go",
			ClientGetter: "github.com/opiuman/genqlient/internal/testutil.GetClientFromNowhere",
			ContextType:  "-",
		}},
